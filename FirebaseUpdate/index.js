...
app.post("/api/portfolio/v1/updateportfolio/:uid/:docid/:stock", (req, res) => {
  (() => {
    try {
      db.collection("users")
          .doc("" + req.params.uid)
          ...
          .update({"Stocks":FieldValue.arrayUnion("" + req.params.stock)})
          .then(function(response) {
          // docid = response.id;
          // response.update({ id: docid });
...
app.get("/api/portfolio/v1/deleteportfolios/:uid", (req, res) => {
  db.collection("users")
      .doc("" + req.params.uid)
      .collection("portfolios")
      .doc("" + req.params.docid)
...
app.get("/api/portfolio/v1/deletestock/:uid/:docid/:stock", (req, res) => {
  db.collection("users")
      .doc("" + req.params.uid)
      .collection("portfolios")
      .doc("" + req.params.docid)
      .update({"Stocks":FieldValue.arrayRemove("" + req.params.stock)})
      //.delete()
      .then(function(doc) {
        return res.status(200).send(doc.data());
      })
